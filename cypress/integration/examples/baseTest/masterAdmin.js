...
describe ('Master|Admin|Desktop|UA|', function(){
  ...
  it('3. Редагування мобільного номера Клієнта:'+idClient, function(){
    ...
    it('4.Додати Н/З, підтягування клієнта через пошук, клієнт: '+idClient, function(){
        cy.visit(baseUrl+'/add').then(function(){
            cy.get('h1').should('have.text','Додати Ремонт')
            cy.get('#searchClientQuery').type(`БазовийКлієнт${idClient}`)
            cy.wait(2000)
  ...
  it('5.Редагування н/з та додавання Поста, Механіка, Готівки, Реквізити STO, Пробіг', function(){
        cy.visit(baseUrl+'/orders/appointments').then(function(){
  ...
  it('6. Перевірка заповнених полів: Поста, Механіка, Готівки, Реквізити STO, Пробіг, Знижка', function(){
        cy.visit(baseUrl+'/orders/appointments').then(function(){
            cy.get('.ant-input-search > .ant-input').type(idClient)
            cy.wait(2000);
            cy.get('.styles-m__ordernLink---T-qWz').first().click({ force: true });//Нові н/з
  ...
  it('7.Вибір Локації', function(){
    ...
    it('8.Перевірка Інфо по автомобілю ', function(){
        cy.visit(baseUrl+'/orders/appointments').then(function(){
            cy.wait(3000);
            cy.get('.ant-input-search > .ant-input').type(idClient)
            cy.wait(2000);
            ...
            cy.wait(4000);
            cy.get('[title="Інфо по автомобілю"] > .anticon > svg').click().then(function(){
                cy.wait(8000);
  ...
  it('9.Перевід у статус Запис', function(){
         cy.visit(baseUrl+'/orders/appointments').then(function(){
            ...
            cy.get('.ant-dropdown-menu-item').contains('Запис').first().click({ force: true });  ///Перевести н/з в статус Запис
            cy.wait(3000);
            cy.get('h1 > span').should('have.text','Запис') 
        })
    });

  it('10.Створення Діагностики', function(){
    cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.get('.ant-input-search > .ant-input').type(idClient)
            cy.wait(2000);
            cy.get('a.styles-m__ordernLink---T-qWz').first().click({force: true});
            cy.log('Вибір Запису');
  ...
  it('11.Редагування ціни для доданої Роботи з діагностики', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.wait(3000);
            cy.get('.ant-input-search > .ant-input').type(idClient)
            cy.wait(2000);
  ...
  it('12.Додавання Робіт через групи Товарів', function(){
    cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.get('.ant-input-search > .ant-input').type(idClient)
            cy.wait(2000);
            cy.get('a.styles-m__ordernLink---T-qWz').first().click({force: true});
  ...
  it('13. Додавання Робіт через поле Робіт', function(){
    cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.get('.ant-input-search > .ant-input').type(idClient)
            cy.wait(2000);
            cy.get('a.styles-m__ordernLink---T-qWz').first().click({force: true});
    ...
    it('14. Додавання Робіт повторно', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
    ...
    it('15. Вкладка Роботи > Додавання Роботи ч/з Комплекси', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
            cy.get('a.styles-m__ordernLink---T-qWz').first().click({force: true});
  ...
  it('19. Вкладка Запчастини > Додавання ЗЧ по VIN', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
            ...
            cy.wait(1000);
            cy.get('.styles-m__categoryList---GtUxE').should('exist')
            cy.wait(1000);
    ...
    it('22. Додавання Товару через модалку Товару', function(){
        cy.visit(baseUrl+'/products').then(function(){
            cy.wait(2000);
            ...
            cy.wait(3000);
            cy.get('tr > td ').first().should('exist')
        })
    });

    it('23. Додавання нового Товару з НЗ в Довідник Товарів', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.wait(3000);
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
  ...
  it('24. Прихід від Постачальника', function(){
        cy.get('img').eq(0).click({force: true}) //menu
        ...
        //// Підтягування Товару 1.2 з коміркою
        cy.get('.ant-btn').eq(1).click({force: true})
        cy.wait(2000);
        cy.get('.ant-modal-body').find('.ant-btn').click()
        cy.wait(2000);
        cy.log('Додавання коду Товару створеного в п 1.1');
        ...
        cy.get('.ant-modal-footer > div > .ant-btn-primary').first().click({force: true})
        cy.wait(2000);
        //// Підтягування Товару 1.1 без комірки
        cy.get('.ant-btn').eq(1).click({force: true})
        cy.wait(2000);
        cy.get('.ant-modal-body').find('.ant-btn').click()
        cy.wait(2000);
  ...
  it('25. Узгодження замовлення', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
            cy.get('a.styles-m__ordernLink---T-qWz').first().click({force: true});
  ...
  it('26.Редаг. Закуп. ціни / ПД Схвалено в табці Роботи', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.log('Вибір Запису');
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
            ...
            cy.log('Закупочна ціна');
            cy.get('.ant-table-row > :nth-child(4) > .ant-input-number > .ant-input-number-input-wrap > .ant-input-number-input').clear().type('88');
            cy.wait(1000);
            cy.get('.ant-btn-primary').last().click({force: true})
            cy.wait(1000);
        })
    ...
    it('27. Редагування Закупочної ціни / ПД Схвалено в табці Запчастини', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
                cy.wait(3000);
                cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
                cy.wait(2000);
    ...
    it('28. Перевід у статус Ремонту', function(){
        cy.visit(baseUrl+'/orders/approve').then(function(){
            cy.wait(3000);
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
    ...
    it('29. Ремонт / Цех', function(){
        cy.visit(baseUrl+'/orders/progress').then(function(){
            cy.wait(3000);
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
            cy.get('a.styles-m__ordernLink---T-qWz').first().click({force: true});
    ...
    it('30. Додавання Коментарів', function(){
        cy.visit(baseUrl+'/orders/progress').then(function(){
            cy.wait(4000);
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
  ...
  it('31. Оплата і видача / Статус завершено ', function(){
        cy.visit(baseUrl+'/orders/progress').then(function(){
            cy.wait(4000);
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
    ...
    it('32. Статистика по НЗ', function(){
        cy.visit(baseUrl+'/orders/success').then(function(){
            cy.wait(4000);
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
            cy.get('a.styles-m__ordernLink---T-qWz').first().click({force: true});
    ...
    it('33.Завантаження НЗ для Клієнта', function(){
        cy.visit(baseUrl+'/orders/success').then(function(){
            cy.wait(3000);
            cy.get('.ant-input-search > .ant-input').type(idClient)//пошук
            cy.wait(2000);
  ...
  it('38. Перевірка відкриття сторінки Деталі в Роботі', function(){
    ...
    it('39. Копія НЗ', function(){
        cy.visit(baseUrl+'/orders/success').then(function(){
            ...
            cy.get('.ant-modal-confirm-btns > .ant-btn-primary').click({force: true}).then(function(){
                cy.wait(12000);
    ...
    it('40. Видалення НЗ / попередньої копії', function(){
        cy.visit(baseUrl+'/orders/appointments').then(function(){
            cy.wait(4000);
            cy.get('a.styles-m__ordernLink---T-qWz').first().invoke('text')
            .then (text => {codeNZ = text;
