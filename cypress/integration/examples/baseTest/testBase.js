...
describe ('BaseTest|UA|CarBook', function(){
  beforeEach('User LogIn ', () => {
    ...
    cy.visit(baseUrl)
    cy.get('#login.ant-input').type(Cypress.env('DevLogin'));  // ProdLogin     DevLogin      ProdLogin     //  TestSpecialistPassword
  ...
  it('1.Профіль вибір українського інтерфейсу', function(){
    ...
    .then (()=>{
      //  cy.get('.ant-tabs-tab').contains('Налаштування').click()
  ...
  it('5.Редагування н/з та додавання Поста, Механіка, Готівки, Реквізити STO, Пробіг', function(){
      ...
      cy.contains('Ремонти').click()
        ...
        .then(()=>{
            ...
            cy.get('#employee').type('Vika').click();
            cy.wait(1000);
            cy.get('.ant-select-dropdown-menu-item-active').click();
        })
        .then(()=>{
        ...
        .then(()=>{
            ...
            cy.get ('#appurtenanciesResponsible').type('vika')
            cy.get('.ant-select-dropdown-menu-item-active').click();
            cy.wait(1000);
  ...
  it('6.Вибір Локації', function(){
      ...
      cy.wait(2000);
      cy.get('.styles-m__locationWrapper---eCnDV > .ant-select > .ant-select-selection> :nth-child(2)').click();
      cy.wait(2000);
      cy.get('.ant-select-dropdown-menu-item-active').click();
      cy.wait(3000);
  ...
  it('10.Редагування ціни для доданої Роботи з діагностики', function(){
    ...
    cy.wait(1000);
    cy.get(':nth-child(1) > [title="Швидке редагування"] > div').click({force: true})
    cy.wait(1000);
...
it('13.Вкладка Роботи > Додавання Роботи ч/з Комплекси', function(){
    ...
    it('14.Відображення механіка в табці Роботи  ', function(){
        ...
        .then(()=>{
          ...
          //cy.get('.ant-tabs-tabpane-active > .ant-table-wrapper > .ant-spin-nested-loading > .ant-spin-container > .ant-table > .ant-table-content > .ant-table-body > table > .ant-table-tbody > [data-row-key="0"] > :nth-child(5) > .ant-select > .ant-select-selection').contains('Vika').should('exist')
            cy.get('[data-row-key="0"] > :nth-child(6) > .ant-select > .ant-select-selection').contains('Vika').should('exist')
            cy.wait(1000)
            cy.log('Механік // + з модалки Робота');
          //cy.get('.ant-tabs-tabpane-active > .ant-table-wrapper > .ant-spin-nested-loading > .ant-spin-container > .ant-table > .ant-table-content > .ant-table-body > table > .ant-table-tbody > [data-row-key="1"] > :nth-child(5) > .ant-select > .ant-select-selection').contains('Vika').should('exist')
            cy.get('[data-row-key="1"] > :nth-child(6) > .ant-select > .ant-select-selection').contains('Vika').should('exist')
            cy.wait(1000)
          //  cy.get('.ant-tabs-tabpane-active > .ant-table-wrapper > .ant-spin-nested-loading > .ant-spin-container > .ant-table > .ant-table-content > .ant-table-body > table > .ant-table-tbody > [data-row-key="2"] > :nth-child(5) > .ant-select > .ant-select-selection').contains('Vika').should('exist')
            cy.get('[data-row-key="2"] > :nth-child(6) > .ant-select > .ant-select-selection').contains('Vika').should('exist')
            cy.wait(1000)
            cy.log('Механік // + робрти з модалки Комплекси');
            //cy.get('.ant-tabs-tabpane-active > .ant-table-wrapper > .ant-spin-nested-loading > .ant-spin-container > .ant-table > .ant-table-content > .ant-table-body > table > .ant-table-tbody > [data-row-key="3"] > :nth-child(5) > .ant-select > .ant-select-selection').contains('Vika').should('exist')
            cy.get('[data-row-key="3"] > :nth-child(6) > .ant-select > .ant-select-selection').contains('Vika').should('exist')
...
it('21. Додавання нового Товару з НЗ в Довідник Товарів', function(){
    ...
    cy.get('.ant-modal-footer > div > .ant-btn-primary').last().click({force: true}) //ok
    cy.wait(3000);
   // cy.log('Додавання Товару в Довідник Товарів (іконка +)');
  //  cy.get(':nth-child(10) > div > .ant-btn').last().click()
  //  cy.get('.ant-btn-primary').last().click({force: true}) //ok
   });
  ...
  it('22. Прихід від Постачальника', function(){
    ...
    cy.get('.ant-select > .ant-select-selection').eq(2).type('Exist')
    cy.wait(2000);
    cy.get('.ant-select-dropdown-menu-item').click()
    cy.wait(2000);
    cy.get('.ant-badge > .anticon').click()
    cy.wait(5000);
   ...
   // Підтягування Товару 1.2
    ...
    cy.get('.ant-input-affix-wrapper > .ant-input').type(idClient+'X')
    cy.wait(2000);
    ...
    cy.get('.ant-input-affix-wrapper > .ant-input').type(idClient+'X')
    //
    ////cy.get('.ant-table-column-sorters > :nth-child(1) > .ant-select > .ant-select-selection').type('100 Plus')
    /////cy.wait(2000);
    ////cy.get('.ant-select-dropdown-menu-item').click()
    ///cy.wait(2000);
    //
